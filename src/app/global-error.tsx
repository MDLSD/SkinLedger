 ...
 *
 * Единственный экран без перевода. Он подменяет собой layout `[locale]`,
 * а вместе с ним и NextIntlClientProvider: взять язык здесь неоткуда,
 * и падать в этой точке во второй раз нельзя. Поэтому текст на языке
 * по умолчанию.
 */
